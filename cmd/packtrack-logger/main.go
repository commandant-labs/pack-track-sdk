...
func main() {
	...
	flag.StringVar(&cfg.RunID, "run-id", "", "workflow run id (required unless using --file/--stdin)")
	...
	flag.StringVar(&cfg.Status, "status", "", "status [ok|failed|skipped|timeout|retrying|unknown]")
